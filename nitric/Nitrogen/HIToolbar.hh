...
/*==========================================================================*/
	using ::HIToolbarRef;
	template<> struct DescType_Traits< typeHIToolbarRef		>: nucleus::POD_scribe< HIToolbarRef > {};
...
/*==========================================================================*/
	...
	template<> struct DescType_Traits< typeHIToolbarItemRef	>: nucleus::POD_scribe< HIToolbarItemRef > {};
