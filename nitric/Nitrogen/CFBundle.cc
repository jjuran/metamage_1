...
namespace Nitrogen
{
	...
	{
		CFArrayRef result = ::CFBundleCreateBundlesFromDirectory( allocator,
		                                                          directoryURL,
		                                                          bundleType );
	...
	CFTypeRef CFBundleGetValueForInfoDictionaryKey( CFBundleRef  bundle,
	                                                CFStringRef  key )
	{
		CFTypeRef result = ::CFBundleGetValueForInfoDictionaryKey( bundle,
		                                                           key );
	...
	{
		CFURLRef result = ::CFBundleCopyResourceURL( bundle,
		                                             resourceName,
		                                             resourceType,
		                                             subDirName );
