...
namespace vlib
{
	...
	enum precedence_level
	{
		...
		Precedence_declarator,      // const let var def
		...
		Precedence_map,             // map gap pop any all ver per
	...
	static const precedence_mapping precedence_table[] =
	{
		...
		{ Precedence_map, Op_pop },
		{ Precedence_map, Op_any },
		{ Precedence_map, Op_all },
		...
		{ Precedence_assignment, Op_setAND_with },
		{ Precedence_assignment, Op_setXOR_with },
		{ Precedence_assignment, Op_setOR_with  },
