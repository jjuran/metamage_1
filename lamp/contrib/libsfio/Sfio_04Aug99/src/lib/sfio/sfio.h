...
/* Symantec C/C++ passes floating point varargs as long double, not double */
#ifdef __SC__
#define SFDOUBLE_T_FORCE	1
#else
#define SFDOUBLE_T_FORCE	0
#endif
...
#define SFFMT_SET	01777700 /* flags settable on calling extf	*/
...
extern int		sfdcsubstream _ARG_((Sfio_t*, Sfoff_t, Sfoff_t));
