/*
	...
	Data tables for Macintosh Audio Compression/Expansion (MACE),
	copied from mace.c in FFmpeg's libavcodec.
...
const int16_t table_1[] = { -13, 8, 76, 222, 222, 76, 8, -13 };

const int16_t table_3[] = { -18, 140, 140, -18 };

const int16_t table_2[][ 4 ] =
{
